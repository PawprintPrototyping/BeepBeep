...
from hardware.ulcdscreen import LcdScreen
...
def handle_card_reader(config_json: typing.Dict) -> CardReader:
    ...
    if card_reader_type == CardReaderTypes.Pn532I2c.value:
        sda_pin: typing.Optional[int] = _pull_int_from_config(config_json=card_reader_json, key="sda_pin",
                                                              optional=False)
        scl_pin: typing.Optional[int] = _pull_int_from_config(config_json=card_reader_json, key="scl_pin",
                                                              optional=False)
        card_baud: typing.Optional[int] = _pull_int_from_config(config_json=card_reader_json, key="card_baud",
                                                              optional=True)
        read_timeout_ms: typing.Optional[int] = _pull_int_from_config(config_json=card_reader_json, key="read_timeout_ms",
                                                              optional=True)
        i2c_freq: typing.Optional[int] = _pull_int_from_config(config_json=card_reader_json, key="i2c_freq",
                                                                   optional=True)
        if i2c_freq is None:
            i2c_freq = 400000
        ...
        tx_pin: typing.Optional[int] = _pull_int_from_config(config_json=card_reader_json, key="tx_pin",
                                                              optional=False)
        rx_pin: typing.Optional[int] = _pull_int_from_config(config_json=card_reader_json, key="rx_pin",
                                                              optional=False)
        card_baud: typing.Optional[int] = _pull_int_from_config(config_json=card_reader_json, key="card_baud",
                                                                optional=True)
        read_timeout_ms: typing.Optional[int] = _pull_int_from_config(config_json=card_reader_json,
                                                                      key="read_timeout_ms",
                                                                      optional=True)
        ...
        pin0: typing.Optional[int] = _pull_int_from_config(config_json=card_reader_json, key="pin0",
                                                             optional=False)
        pin1: typing.Optional[int] = _pull_int_from_config(config_json=card_reader_json, key="pin1",
                                                             optional=False)
        uid_32bit_mode: typing.Optional[bool] = _pull_bool_from_config(config_json=card_reader_json, key="uid_32but_mode",
                                                           optional=True)
...
def _handle_lcd(config_json: typing.Dict) -> typing.Optional[LcdScreen]:
    # TODO: This should probably be a sub-entry in the config dictionary, like the readers
...
def _handle_buzzer(config_json: typing.Dict) -> typing.Optional[Buzzer]:
    ...
    if buzzer_pin is not None:
        buzzer_type: typing.Optional[str] = _pull_str_from_config(config_json=config_json, key="buzzer_type",
                                                                  optional=True)
...
def _handle_reader_led(config_json: typing.Dict) -> typing.Optional[SimpleStatusLed]:
    ...
    reader_led_pin: typing.Optional[int] = _pull_int_from_config(config_json=config_json, key="reader_led_pin",
                                                                 optional=True)
    if reader_led_pin is not None:
        reader_led_reversed: bool = _pull_bool_from_config(config_json=config_json, key="reader_led_reversed",
                                                           optional=True)
...
def _handle_door_lock(config_json: typing.Dict) -> typing.Optional[typing.Union[SimpleLock, SensibleLock]]:
    ...
    door_lock_pin: typing.Optional[int] = _pull_int_from_config(config_json=config_json, key="door_lock_pin",
                                                                optional=True)
